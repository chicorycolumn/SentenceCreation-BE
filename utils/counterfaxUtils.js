...
exports.removeAnnotationsByCounterfactualAnswerSentences = (
    ...
    (counterfactualSitSchematic, index) => {
      ...
      counterfactualSitSchematic.chunkIds.forEach((chunkId) => {
        ...
        allLangUtils.adjustVirilityOfStructureChunk(
          //herehere have yet to put semanticGender loop into this fxn too.
          questionLanguage,
          stChToCounterfax,
          true,
          true
      ...
      counterfactualQuestionSentenceFormula.sentenceStructure.forEach(
        (stCh) => {
          ...
          if (stCh.demandedIds && stCh.demandedIds.length > 1) {
            consol.throw(
              "igtd Surely Question chunk should only have one specificId."
            );
          }
  ...
  allCounterfactualResults.forEach((cfRes) => {
    consol.logSpecial(
      ...
      cfRes.questionSentenceData.questionOutputArr.map((ou) => ou.selectedWord),
