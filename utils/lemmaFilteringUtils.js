...
exports.selectRandLObj = (lObjs, stCh, lang) => {
  const _returnLObj = (lObj, stCh, label) => {
    ...
    consol.logSpecial(8, `selectRandLObj (via ${label}) selected "${lObj.id}"`);
    consol.logSpecial(
      8,
      `"-,-"-.-"-,-"-.-"-,-"-.-"-,-"-.-"-,-"-.-"-,-"-.-"-,-"-.-"-,-"-.-"`
    );
  ...
  //// Neon
  /**If stCh.number holds only "singular"
   * and if lObjs.includes any with gender "_VypernymGenders"
   * then exclude those vypernym gender ones
   */
  ...
  // if ( // Garibaldi I just nixed this, but had been in place for a while.
  //   stCh.number &&
  //   stCh.number.length &&
  //   stCh.number.every((tv) => tv === "singular")
  // ) {
  //   lObjs = lObjs.filter((l) => l.semanticGender !== "_VypernymGenders");
  // }
...
exports.updateStructureChunk = (
  ...
  uUtils.validateArrayQuasiEmpty(outputUnit.structureChunk.semanticGender, 27);
  ...
  uUtils.validateArrayQuasiEmpty(outputUnit.structureChunk.semanticGender, 28);
  ...
  uUtils.validateArrayQuasiEmpty(outputUnit.structureChunk.semanticGender, 29);
  ...
  uUtils.validateArrayQuasiEmpty(outputUnit.structureChunk.semanticGender, 30);
};
...
exports.updateStChByAndTagsAndSelectors = (
  ...
  consol.logSpecial(8, "ulno", structureChunk);

  uUtils.validateArrayQuasiEmpty(structureChunk.semanticGender, 20);
  ...
  if (selectedLemmaObject.semanticGender) {
    if (isCounterfax) {
      ...
      consol.logSpecial(8, "----------", structureChunk.semanticGender);
      consol.logSpecial(8, "----------");
      consol.logSpecial(8, "----------");
      ...
      // console.log("gggg", { numberValue, virilityRefByNumber });
      ...
      const _accumulateGenderValues = (
        ...
        stCh[genderTraitKey].forEach((genderValue) => {
          ...
          //   genderValue,
          //   additionalNumberAdjustedGenderValues,
          //   "stCh[genderTraitKey]": stCh[genderTraitKey],
          //   "stCh[genderTraitKey].length": stCh[genderTraitKey].length,
          // });
      ...
      // console.log("kkkk", numberAdjustedGenderValues);
      ...
      // console.log("llll", numberAdjustedGenderValues);
      ...
      if (structureChunk.semanticGender) {
        ...
        // consol.throw(
        //   `irta ${currentLanguage} Didn't expected ${structureChunk.chunkId} structureChunk.semanticGender to be set yet.`
        // );
      }
  ...
  uUtils.validateArrayQuasiEmpty(outputUnit.structureChunk.semanticGender, 21);
  ...
  uUtils.validateArrayQuasiEmpty(outputUnit.structureChunk.semanticGender, 22);
  ...
  uUtils.validateArrayQuasiEmpty(outputUnit.structureChunk.semanticGender, 23);
  ...
  uUtils.validateArrayQuasiEmpty(outputUnit.structureChunk.semanticGender, 24);
  ...
  uUtils.validateArrayQuasiEmpty(outputUnit.structureChunk.semanticGender, 25);
  ...
  uUtils.validateArrayQuasiEmpty(outputUnit.structureChunk.semanticGender, 26);
