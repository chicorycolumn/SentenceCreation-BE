  ...
  ENG: {
    ...
    justOneGenderValue: {
      singular: {
        ...
        f: "f",
        n: "n",
        virile: "_allPersonalSingularGenders",
        nonvirile: "_allSingularGenders",
      },
      plural: {
        m: "virile",
        f: "nonvirile",
  ...
  POL: {
    ENG: {
      gender: {
        ...
        m2: ["m"],
        m3: ["m"],
        _allSingularGendersExcludingNeuter: ["_allPersonalSingularGenders"],
        _allSingularGendersExcludingNeuterWithPadding: ["_allSingularGenders"],
