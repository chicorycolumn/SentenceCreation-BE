...
exports.processSentenceFormula = (
  ...
  let { multipleMode, forceMultipleModeAndQuestionOnly } = maqModes;
...
exports.giveFinalSentences = (
  ...
  let { multipleMode, forceMultipleModeAndQuestionOnly, isQuestion } = maqModes;
...
exports.addContractions = (sentence, lang, coverAllOrMostPermutations) => {
  ...
  const _addContractionsForSentence = (
    ...
    probability,
    ifFollowedByWord,
    coverAllOrMostPermutations
  ) => {
    let resArr = coverAllOrMostPermutations ? [s] : [];

    let targets = Object.keys(ref);

    _getAndPushToRes(s, resArr, targets, ref, ifFollowedByWord, probability);

    if (coverAllOrMostPermutations) {
      _getAndPushToRes(s, resArr, targets, ref, ifFollowedByWord, probability);
      _getAndPushToRes(s, resArr, targets, ref, ifFollowedByWord, probability);
      _getAndPushToRes(s, resArr, targets, ref, ifFollowedByWord, probability);
      _getAndPushToRes(s, resArr, targets, ref, ifFollowedByWord, probability);
...
exports.getProducedSentence = (
  ...
  if (
    !formattingOptions.suppressContractions &&
    (isQuestion || forceMultipleModeAndQuestionOnly)
  ) {
    // console.log("swde");
    // console.log("OOO");
    // console.log("OOO");
